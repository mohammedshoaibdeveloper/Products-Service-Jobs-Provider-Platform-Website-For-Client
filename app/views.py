...
def index(request):
    try:
        ...
        return render(request,'home.html',{'product':allProds,'navbar':navdata,'service1':service1,'service2':service2,'service3':service3,'job1':job1,'job2':job2,'job3':job3})
    except:
...
def serviceview(request,id):
    ...
    navdata=category.objects.all()
    return render(request,'serviceview.html',{'service':service,'navbar':navdata,'singleservice':singleservice})
